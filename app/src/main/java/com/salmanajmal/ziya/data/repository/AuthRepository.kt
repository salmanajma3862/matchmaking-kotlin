...
import com.salmanajmal.ziya.data.api.AuthApiService
            ...
            if (response.isSuccessful && response.body() != null) {
                ...
                if (errorBody != null) {
                    try {
                        ...
                        val authResponse = gson.fromJson(errorBody, com.salmanajmal.ziya.data.models.response.AuthResponse::class.java)
